  ...
  return (
    <Card
      ...
      className={cn(
        ...
        "bg-card text-card-foreground flex flex-col gap-6 rounded-xl py-6 focus-visible:ring-ring focus-visible:ring-1 focus-visible:ring-offset-1 focus-visible:outline-hidden touch-none select-none cursor-grab border-0 hover:shadow-md transition-shadow",
