...
/**
 * Collection-specific chat input that passes collectionId in context
 */
const CollectionChatInput: React.FC<{ collectionId: string }> = ({ collectionId }) => {
  ...
  const handleSend = async () => {
    ...
    // Send message with collectionId in context override
    await sendMessage(message, undefined, { collectionId });
  };
...
/**
 * Collection-specific chat panel with RAG
 * Uses existing ChatContext but passes collectionId for collection-scoped search
 */
export const CollectionChatPanel: React.FC<Props> = ({ collectionId }) => {
  return (
    <div className="h-full flex flex-col">
      <ChatConversation />
      <CollectionChatInput collectionId={collectionId} />
    </div>
  );
};
